# Production Environment - ANC Platform Terraform Configuration
# High-availability configuration suitable for production workloads
# Features:
#   - Multi-AZ deployment for fault tolerance
#   - Larger instance sizes for performance
#   - Spot instances disabled for stability
#   - Full replication and backups enabled
